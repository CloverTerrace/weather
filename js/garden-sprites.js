...
(() => {
  const CATALOG = {
    ...
    summer: [
      ...
      { id:'summer-zinnia', file:'flowers/flower28.png', x:.08,y:.69,size:42,minWidth:520,layer:'front',priority:85 },
      { id:'summer-pinkzinnia', file:'flowers/flowers29.png', x:.56,y:.78,size:42,minWidth:520,layer:'front',motion:'sway',priority:85 },
      { id:'summer-red', file:'flowers/flower-red.png', x:.73,y:.82,size:42,minWidth:650,layer:'front',priority:85 },
      { id:'summer-cluster', file:'flowers/flowers49.png', x:.92,y:.72,size:44,minWidth:760,layer:'front',motion:'sway',priority:85 },
      { id:'summer-colorful', file:'flowers/flower-cluster-colorful.png', x:.16,y:.86,size:54,minWidth:850,layer:'front',priority:75 },
      { id:'summer-coneflower', file:'flowers/flowers31.png', x:.84,y:.85,size:62,minWidth:1000,layer:'back',motion:'sway',priority:75 },
      { id:'summer-rose', file:'flowers/flowers42.png', x:.12,y:.57,size:38,minWidth:900,layer:'back',clickable:true,interaction:'tip',tip:'A little summer bloom tucked into the garden.',priority:65 },
      { id:'summer-sunflower', file:'flowers/sunflower.png', x:.88,y:.59,size:50,minWidth:1050,layer:'back',clickable:true,interaction:'tip',tip:'Sunflowers turn their faces toward the light.',priority:65 },
      { id:'summer-mushroom-red', file:'decorations/mushroom-red.png', x:.29,y:.88,minWidth:700,layer:'front',clickable:true,interaction:'spore-cloud',tip:'Tap the mushroom.',priority:80 },
      { id:'summer-mushroom-cluster', file:'decorations/mushroom-red-cluster.png', x:.78,y:.90,minWidth:1150,layer:'front',clickable:true,interaction:'spore-cloud',tip:'A tiny mushroom patch.',priority:60 },
      { id:'summer-rocks', file:'decorations/mossrock3.png', x:.48,y:.91,size:62,minWidth:1250,layer:'front',priority:50 },
